...
class PostgreSQLDatabase:
    ...
    def __init__(self):
        ...
        self.config = {
            ...
            'user': os.getenv('POSTGRES_USER', os.getenv('MYSQL_USER', 'tgbot_user')),
            'password': os.getenv('POSTGRES_PASSWORD', os.getenv('MYSQL_PASSWORD', 'your_password_here')),
            'dbname': os.getenv('POSTGRES_DATABASE', os.getenv('MYSQL_DATABASE', 'tgbot_verify')),
        }
        # 避免日志泄露敏感信息
        logger.info("PostgreSQL 数据库初始化")
        self.init_database()
    ...
    def init_database(self):
        ...
        try:
            ...
            cursor.execute("CREATE INDEX IF NOT EXISTS idx_verif_user_id ON verifications(user_id)")
    ...
    def is_user_blocked(self, user_id: int) -> bool:
        ...
        return user and user["is_blocked"] == True
    ...
    def get_blacklist(self) -> List[Dict]:
        ...
        try:
            cursor.execute("SELECT * FROM users WHERE is_blocked = TRUE")
